...
import '../../../feature_see_all_mobile/view/see_all_screen_mobile.dart';
      ...
      child: Row(
        children: [
          RichText(text: TextSpan(children: [
            TextSpan(text: "${title1} ",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w900,fontSize:Responsive.isMobile(context)?25:5.sp)),
